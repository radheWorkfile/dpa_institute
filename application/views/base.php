...
<head>
	...
	<title><?php echo $custom_setting->company_name ? $custom_setting->company_name : config_item('company_name'); ?> |
		Admin </title>
...
<body>
	...
	<div id="main-wrapper">
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-body">
						<button type="button" class="btn-close rvClose" data-bs-dismiss="modal"
							aria-label="Close"></button>
						<div class="delsMsg"><i class="fa fa-trash"></i> Delete Details</div>
						<div class="actnData"><i class="fa fa-exclamation-triangle"></i> Do you wish to delete request
							details ?</div>
						<div id="mdlFtrBtn">
							<button type="button" class="btn btn-outline-danger pull-right getTargetAction"
								id="cnfChanges" data-id="@misingh">Confirm Delete <i
		...
		<?php $this->load->view('include/top_navbar');
		...
		***********************************-->
					...
					<div class="row">
						<div class="col-xl-9 col-xxl-12">
							<div class="row" id="dd-sm-cup">
								...
								<div class="row">
									<div class="col-xl-4 my-3 my-lg-0 col-xxl-4 col-lg-4 col-sm-6">
										<div class="box-shadow p-3 bg-g shadow-hover">
											<p class="text-center font-size-2"><span
													class="p-3 text-white border-radius-2"><i class="fa fa-inr"
														aria-hidden="true"></i></span></p>
											<p class="text-center text-white mt--2">Wallet Amount<span>&nbsp;( ₹
													<?php echo $total_amo_with_project ? $total_amo_with_project . '.00' : '<span class="text-canger">0.00</span>'; ?>
													)</span></p>
											<p class="text-center"><a href="<?php echo base_url(); ?>donation/donatePay"
													class="text-white"><span
														class="px-5 py-2 cursor-pointer border-1 border-radius-1">View
														More</span></a></p>
										</div>
									</div>
									...
									<div class="col-xl-4 my-3 my-lg-0 col-xxl-4 col-lg-4 col-sm-6">
										<div class="box-shadow p-3 bg-g shadow-hover">
											<p class="text-center font-size-2"><span
													class="p-3 text-white border-radius-2"><i class="fa fa-inr"
														aria-hidden="true"></i></span></p>
											<p class="text-center text-white mt--2">Donation Amount<span>&nbsp;( ₹
													<?php echo $donation_amo['amount'] ? $donation_amo['amount'] . '.00' : '<span class="text-canger">0.00</span>'; ?>
													)</span></p>
											<p class="text-center "><a
													href="<?php echo base_url(); ?>donation/donatePay"
													class="text-white"><span
														class="px-5 py-2 cursor-pointer border-1 border-radius-1">View
														More</span></a></p>
										</div>
									...
									<div class="col-xl-4 my-3 my-lg-0 col-xxl-4 col-lg-4 col-sm-6">
										<div class="box-shadow p-3 bg-g shadow-hover">
											<p class="text-center font-size-2"><span
													class="p-3 text-white border-radius-2"><i class="fa fa-inr"
														aria-hidden="true"></i></span></p>
											<p class="text-center mt--2 text-white">Today Donation<span>&nbsp;( ₹
													<?php echo $today_donation_amo['amount'] ? $today_donation_amo['amount'] . '.00' : '<span class="text-canger">0.00</span>'; ?>
													)</span></p>
											<p class="text-center "><a
													href="<?php echo base_url(); ?>donation/donatePay"
													class="text-white"><span
		...
		<p class="text-center text-white mt--2">Total Volunteer<span>&nbsp;( <?php echo $total_volunteer ? $total_volunteer : '<span class="text-canger">N/A</span>'; ?> )</span></p>
		<p class="text-center mt--1"><a href="<?php echo base_url(); ?>website/volunteer" class="text-white"><span class="px-3 cursor-pointer border-1 border-radius-1">View More</span></a></p>
		</div>		
		</div>	 -->
									...
									<div class="col-xl-4 my-3 my-lg-0 col-xxl-4 col-lg-4 col-sm-6">
										<div class="box-shadow p-3 bg-g shadow-hover">
											<p class="text-center font-size-2"><span
													class="p-3 text-white border-radius-2"><i class="fa fa-user"
														aria-hidden="true"></i></span></p>
											<p class="text-center mt--2 text-white">Total Member <span>&nbsp;(
													<?php echo $total_member ? $total_member : '<span class="text-canger">N/A</span>'; ?>
													)</span></p>
											<p class="text-center "><a
													href="<?php echo base_url(); ?>administrator/member/manage"
													class="text-white"><span
														class="px-5 py-2 cursor-pointer border-1 border-radius-1">View
														More</span></a></p>
										</div>
									...
									<div class="col-xl-4 my-3 my-lg-0 col-xxl-4 col-lg-4 col-sm-6">
										<div class="box-shadow p-3 bg-g shadow-hover">
											<p class="text-center font-size-2"><span
													class="p-3 text-white border-radius-2"><i class="fa fa-user-plus"
														aria-hidden="true"></i></span></p>
											<p class="text-center text-white mt--2">Total Employee<span>&nbsp;(
													<?php echo $total_emp ? $total_emp : '<span class="text-canger">N/A</span>'; ?>
													)</span></p>
											<p class="text-center "><a
													href="<?php echo base_url(); ?>administrator/employee/statewise"
													class="text-white"><span
														class="px-5 py-2 cursor-pointer border-1 border-radius-1">View
														More</span></a></p>
										</div>
									 ...
									 <div class="col-xl-4 my-3 my-lg-0 col-xxl-4 col-lg-4 col-sm-6">
										<div class="box-shadow p-3 bg-g shadow-hover">
											<p class="text-center font-size-2"><span
													class="p-3 text-white border-radius-2"><i class="fa fa-tasks"
														aria-hidden="true"></i></span></p>
											<p class="text-center text-white mt--2">Assign Project<span>&nbsp;(
													<?php echo $assign_project ? $assign_project : '<span class="text-canger">N/A</span>'; ?>
													)</span></p>
											<p class="text-center "><a href="<?php echo base_url(); ?>administrator/work_assign"
													class="text-white"><span
														class="px-5 py-2 cursor-pointer border-1 border-radius-1">View
														More</span></a></p>
										</div>
									...
									<div class="col-xl-12 col-xxl-12 col-lg-12 col-md-12 col-sm-12 mt-4">
										<div class="card overflow-hidden">
											<div class="card-body px-4 py-4">
												<h5 class="mb-3">1700 / <small class="text-primary">Our Project
														Status</small></h5>
												<div class="chart-point">
													<div class="check-point-area">
														<canvas id="ShareProfit2" width="100" height="100"
													...
													<ul class="chart-point-list">
														...
														<li><i class="fa fa-circle text-warning me-1"></i> 25% Child Care
														</li>
													</ul>
												</div>
											</div>
								...
								<div class="col-xl-8 col-xxl-8 col-lg-8 col-md-8">
									<div id="user-activity" class="card">
										<div class="card-header border-0 pb-0 d-sm-flex d-block">
											<div>
												<h4 class="card-title text-white">Our Project Status 2024 - 2025</h4>
												...
												<ul class="nav nav-tabs" role="tablist">
													<li class="nav-item">
														<a class="nav-link active" data-bs-toggle="tab"
															data-bs-target="#month" href="#user" role="tab"
															aria-selected="true"> Month
														</a>
													</li>

													<li class="nav-item">
														<a class="nav-link" data-bs-toggle="tab" data-bs-target="#week"
															href="#bounce" role="tab" aria-selected="false">Weekly</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" data-bs-toggle="tab" data-bs-target="#today"
															href="#session-duration" role="tab"
						...
						<div class="col-xl-3 col-xxl-4 col-lg-12 col-md-12">
							<div class="card bg-primary text-white">
								<div class="card-header pb-0 border-0">
									<h4 class="card-title text-white">Member List</h4>
								</div>
								<div class="card-body">
									<div class="widget-media">
										<ul class="timeline">
											<?php if ($fiveMember): ?>
												<?php foreach ($fiveMember as $mem): ?>
													<li>
														<div class="timeline-panel">
															<div class="media me-2 media-info" style="font-size:1rem;">M
															</div>
															<div class="media-body">
																<h5 class="mb-1 text-white"><?php echo $mem['name']; ?></h5>
															...
															<div class="dropdown">
																...
																<div class="dropdown-menu">
																	<a class="dropdown-item"
																		href="<?php echo base_url(); ?>administrator/member/manage">Edit</a>
																</div>
															</div>
														</div>
													</li>
												...
												<li>
													<div class="timeline-panel">
														<div class="media me-2 media-info">M
														</div>
														<div class="media-body">
