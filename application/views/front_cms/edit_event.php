...
<div class="content-body">
      ...
      <div class="basic-form" id="bannerCreate_sec">
          ...
          <form id="create_event" data-id="<?php echo base_url('website/front_cms/update_event');?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
            ...
            <strong class="upload-area__tooltip">png, jpeg, jpg
            ...
            <p class="drop-zoon__paragraph text-success"><?php echo $isEventData->e_images ? '<img src="' . base_url($isEventData->e_images) . '" alt="" style="height:4rem;">' : 'Drop your file here or Click to browse'; ?></p>
            ...
            <input type="text" class="form-control border-left-end" name="slider_heading" id="slider_heading" value="<?php echo $isEventData->e_heading;?>" placeholder="Enter Heading.." required="">
            <input type="hidden" class="form-control border-left-end" name="id" id="id" value="<?php echo $isEventData->id;?>" required="">
            ...
            <div class="input-group">
            <span class="input-group-text"> <i class="fa fa-link text-color"></i> </span>  
            <textarea class="form-control" maxlength="400" rows="4" id="slider_text" name="slider_text" spellcheck="false" required=""><?php echo $isEventData->e_text;?></textarea>
...
<!-- =================================== Status Model section End ======================== -->
    ...
    $("#create_event").on("submit", function (e) {
     ...
     $(document).ready(function() {
     let searchObj = {};
     var targetAction = $('#eventList').attr('data-id');
     targeteventList_item = {
     printTable: function(search_data) {
     getpaginate(search_data, '#eventList', targetAction, 'Only For Tnx id, Month.');
     }
     };
