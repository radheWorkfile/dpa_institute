...
<div class="content-body">
        ...
        <div class="card">
          <div class="card-header">
            ...
            <div class="card-action">
              <ul class="nav nav-tabs" role="tablist">
                <li class="nav-item py-1"> <span class="btn btn-outline-primary" id="banner_section"><b><i
                        class="la la-plus text-danger"></i></b>&nbsp;&nbsp;Create Slider</span>
                </li>
              </ul>
            </div>
          </div>
          <div class="card-body">
            <div class="basic-form" id="bannerCreate_sec">
              ...
              <form id="create_banner" data-id="<?php echo $bannerItem; ?>" method="post" accept-charset="utf-8"
                ...
                <div class="row">
                  ...
                  <div class="col-md-8">
                    ...
                    <div id="uploadArea" class="upload-area">
                        ...
                        <div class="col-md-12">
                          <div class="mb-3">
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control border-left-end" name="slider_heading"
                                id="slider_heading" placeholder="Enter Heading.." required="">
                      ...
                      <div class="row mt-1">
                        <div class="col-md-12">
                          <div class="mb-3">
                            <div class="input-group">
                              <span class="input-group-text"> <i class="fa fa-link text-color"></i> </span>
                              <input type="text" class="form-control border-left-end" name="slider_text"
                                id="slider_text" placeholder="Enter Your text.." required="">
                      ...
                      <button type="submit" class="btn btn-primary float-center mt-1" id="saveDetails"><i
            ...
            <div class="tab-content" id="banner_list">
              <div class="tab-pane fade active show" id="allMembers" role="tabpanel">
                <div class="table-responsive">
                  <table id="bannerList" data-id="<?php echo $targetBanner; ?>"
  ...
  <!-- <script src="<? //php echo base_url('assets/js/admin/employee.js') 
                    ?>"></script> -->
  ...
  <script>
    ...
    $(document).ready(function() {
      $("#create_banner").on("submit", function(e) {
    ...
    $(document).ready(function() {
      let searchObj = {};
      var targetAction = $('#bannerList').attr('data-id');
      bannerListItem = {
        printTable: function(search_data) {
          getpaginate(search_data, '#bannerList', targetAction, 'Only For Tnx id, Month.');
        }
      };
      bannerListItem.printTable(searchObj);
    });
  </script>