...
<div class="row">
            ...
            <div class="input-group">
            <span class="input-group-text"> <i class="fa fa-user"></i> </span>  
            <textarea class="form-control" maxlength="400" rows="8" id="message" name="message"  spellcheck="false" required=""oninput="this.value = this.value.toLowerCase().replace(/[^a-z ]/g, '').replace(/\s+/g, ' ').replace(/\b\w/g, char => char.toUpperCase());"><?php echo $getVolunData->address?$getVolunData->address:'';?></textarea>
            ...
            <p class="drop-zoon__paragraph text-success"><img src="<?php echo base_url() . $getVolunData->image?$getVolunData->image:''; ?>"style="height:3rem;"></p>
