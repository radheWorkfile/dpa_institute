...
<div class="content-body">
    ...
    <form id="create_project" data-id="<?php echo $targetItem;?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">              
            <div class="row">
            ...
            <div class="col-md-6">
            <div class="mb-3">
            <p class="text-man text-dark text-color-g">Choose Start date</p>
            <div class="input-group">
            <span class="input-group-text icon-color"> <i class="fa fa-envelope"></i> </span>
            <input type="date" class="form-control border-left-end" name="s_date" id="s_date" required="">
            <div class="invalid-feedback">Please Enter Heading.
            </div>
            </div>
            </div>
            ...
            <div class="col-md-6">
            <div class="mb-3">
            <p class="text-man text-dark text-color-g">Choose End date</p>
            <div class="input-group">
            <span class="input-group-text icon-color"> <i class="fa fa-mobile"></i> </span>
            <input type="date" class="form-control border-left-end" name="end_date" id="end_date">
            <div class="invalid-feedback">Please Enter Heading.
            </div>
            </div>
            </div>
            ...
            <div class="input-group">
            <span class="input-group-text icon-color"> <i class="fa fa-users"></i> </span>
            <input type="hidden" class="form-control border-left-end" name="projId" id="projId" value="<?php echo $project['project_id']; ?>">
            ...
            <div class="input-group">
            <span class="input-group-text icon-color"> <i class="fa fa-users"></i> </span>
            <input type="text" class="form-control border-left-end" name="proAmount" id="proAmount" placeholder="Enter Project Amount">
            <div class="invalid-feedback">Please Enter Heading.
            </div>
            </div>
            </div>
            ...
            <div class="col-md-6">
            <p class="text-man text-dark text-color-g">&nbsp;Upload File.</p>
