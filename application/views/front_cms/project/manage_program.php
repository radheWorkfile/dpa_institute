...
<div class="content-body">
      ...
      <li class="nav-item py-1"> <span class="btn btn-outline-primary" id="banner_section"><i class="la la-plus text-primary"></i>&nbsp;&nbsp;Create Program</span>      
      </li>
      </ul>
      </div>
      </div>
    ...
    <form id="create_program" method="post" accept-charset="utf-8" enctype="multipart/form-data">              
            <div class="row">
            ...
            <div class="col-md-6">
            <p class="text-man text-c-g">&nbsp;Select Employee</p>
            <div class="mb-3">
            <div class="input-group">
            <span class="input-group-text icon-color"> <i class="fa fa-users"></i> </span>
            ...
            <option value="<?php echo $empList['id']; ?>"><?php echo $empList['first_name'].'  '.$empList['last_name']; ?></option>
            <?php endforeach; ?>
            </select>
            <div class="invalid-feedback">Please Enter Heading.
            </div>
            ...
            <div class="col-md-6">
            <div class="mb-3">
            <p class="text-man text-c-g">Choose Start date</p>
            <div class="input-group">
            <span class="input-group-text icon-color"> <i class="fa fa-envelope"></i> </span>
            <input type="date" class="form-control border-left-end" name="start_date" id="start_date" require >
            <div class="invalid-feedback">Please Enter Heading.
            </div>
            </div>
            </div>
            ...
            <div class="col-md-6">
            <div class="mb-3">
            <p class="text-man text-c-g">Choose End date</p>
            <div class="input-group">
            <span class="input-group-text icon-color"> <i class="fa fa-mobile"></i> </span>
            <input type="date" class="form-control border-left-end" name="end_date" id="end_date" require>
            <div class="invalid-feedback">Please Enter Heading.
            </div>
            </div>
            </div>
            ...
            <div class="col-md-6">
            <p class="text-man text-c-g">&nbsp;Enter Location</p>
            <div class="mb-3">
            <div class="input-group">
            <span class="input-group-text icon-color"> <i class="fa fa-users"></i> </span>
            ...
            <div class="col-md-6">
            <p class="text-man text-c-g">&nbsp;Enter Amount</p>
            <div class="mb-3">
            <div class="input-group">
            <span class="input-group-text icon-color"> <i class="fa fa-users"></i> </span>
            <input type="text" class="form-control border-left-end" name="amount" id="amount" placeholder="Enter Amount..">
            <div class="invalid-feedback">Please Enter Heading.
            </div>
            </div>
            </div>
            ...
            <div class="mb-3">
            <p class="text-man text-c-g">&nbsp;Enter Message</p>
            <div class="input-group">
            <span class="input-group-text icon-color"> <i class="fa fa-address-card"></i> </span>  
            <textarea class="form-control" maxlength="400" rows="9" id="text" name="text" spellcheck="false" oninput="this.value = this.value.toLowerCase().replace(/[^a-z ]/g, '').replace(/\s+/g, ' ').replace(/\b\w/g, char => char.toUpperCase());">Enter Your text..</textarea>
            ...
            <div class="col-md-6">
            <p class="text-man text-c-g">&nbsp;&nbsp;Upload the project screenshot.</p>
                  ...
                  <table id="targetSection" data-id="<?php echo $targetList; ?>" class="table table-hover table-responsive-sm mb-0">
                    <thead class="thead-arvDef">
                      <tr>
                        ...
                        <th><strong>Assign Emp</strong></th>
                        <th><strong>Location</strong></th>
                        <th><strong>Date</strong></th>
                        <th><strong>Amount</strong></th>
                        <th><strong>program Image</strong></th>
