...
<div class="content-body">
      ...
      <div class="basic-form" id="bannerCreate_sec">
          ...
          <form id="create_event" data-id="<?php echo $eventItem;?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
            ...
            <div class="input-group">
            <span class="input-group-text"> <i class="fa fa-link text-color"></i> </span>  
            <textarea class="form-control" maxlength="400" rows="4" id="slider_text" name="slider_text" spellcheck="false" required="" placeholder="Enter Message"></textarea>
