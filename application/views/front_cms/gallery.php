...
<div class="content-body">
      ...
      <li class="nav-item py-1"> <span class="btn btn-outline-primary" id="banner_section"><i class="la la-plus text-primary"></i>&nbsp;&nbsp;Create Gallery</span>      
      </li>
      </ul>
      </div>
      </div>
      ...
      <div class="basic-form" id="bannerCreate_sec">
          ...
          <form id="create_gallery" data-id="<?php echo $galleryItem;?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
            ...
            <input type="text" class="form-control border-left-end" name="user_name" id="user_name" placeholder="Enter Name" required="">
            ...
            <div class="tab-content" id="banner_list">
              <div class="tab-pane fade active show" id="allMembers" role="tabpanel">
                <div class="table-responsive">
                  <table id="galleryList" data-id="<?php echo $targetgalleryList;?>" class="table table-hover table-responsive-sm mb-0">
                    <thead class="thead-arvDef">
                      <tr>
                        <th class="text-center"><strong>S.No</strong></th>
                        <th class="text-center"><strong>Date</strong></th>
                        <th class="text-center"><strong>Gallery Images</strong></th>
...
<!-- =================================== Status Model section End ======================== -->
      ...
      <style>.text-color{color:#006f75;}.mt_1{margin-top:-1rem;}</style>
    ...
    var galleryListData = '';            
     $(document).ready(function() {
     let searchObj = {};
     var targetAction = $('#galleryList').attr('data-id');
     galleryListData = {
