        ...
        <div class="card">
          <div class="card-header">
            ...
            <div class="card-action">
              <ul class="nav nav-tabs" role="tablist">
                <li class="nav-item py-1"> <span class="btn btn-outline-primary" style="padding:0.5rem 1.5rem;"
                    id="banner_section"><i class="la la-plus text-primary"></i>&nbsp;&nbsp;Create Team Member</span>
                </li>
              </ul>
            </div>
          </div>
          <div class="card-body">
            <div class="basic-form" id="bannerCreate_sec">
              ...
              <form id="create" data-id="<?php echo $memberItem; ?>" method="post" accept-charset="utf-8"
                        ...
                        <div class="col-md-12">
                          <div class="mb-3">
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control border-left-end" maxlength="20"
                                name="slider_heading" id="slider_heading" placeholder="Enter Name.." required="">
                      ...
                      <div class="row mt-1">
                        <div class="col-md-12">
                          <div class="mb-3">
                            <div class="input-group">
                              <span class="input-group-text"> <i class="fa fa-link text-color"></i> </span>
                              <input type="text" class="form-control border-left-end" maxlength="26" name="slider_text"
            ...
            <div class="tab-content" id="banner_list">
              <div class="tab-pane fade active show" id="allMembers" role="tabpanel">
                <div class="table-responsive">
                  <table id="teamMemList" data-id="<?php echo $targetTeamMem; ?>"
