        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="basic-form" id="bannerCreate_sec">
              ...
              <form id="create_banner" data-id="<?php echo base_url(); ?>website/front_cms/updateSlider" method="post"
                  ...
                  <div class="col-md-8">
                    ...
                    <div id="uploadArea" class="upload-area">
                      ...
                      <div id="dropZoon" class="upload-area__drop-zoon drop-zoon">
                        ...
                        <p class="drop-zoon__paragraph text-success">
                          <?php echo $isSliderData->banner ? '<img src="' . base_url($isSliderData->banner) . '" alt="" style="height:4rem;">' : 'Drop your file here or Click to browse'; ?>
                        </p>
                          ...
                          <div class="mb-3">
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control border-left-end" name="slider_heading"
                                value="<?php echo $isSliderData->heading; ?>" id="slider_heading"
                          ...
                          <div class="mb-3">
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control border-left-end" name="slider_text"
                                id="slider_text" value="<?php echo $isSliderData->content; ?>"
                                placeholder="Enter Your text.." required="">
                              <input type="hidden" class="form-control border-left-end" name="id" id="id"
                                value="<?php echo $isSliderData->id; ?>" placeholder="Enter Your text.." required="">
