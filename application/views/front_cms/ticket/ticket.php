        ...
        <div class="card">
            ...
            <div class="card-action">
              <ul class="nav nav-tabs" role="tablist">
                <li class="nav-item py-1"> <span class="btn btn-outline-primary" id="banner_section"><i
                      class="la la-plus text-primary"></i>&nbsp;&nbsp;Create Ticket</span>
                </li>
              </ul>
            </div>
          </div>
          <div class="card-body">
            <div class="basic-form" id="bannerCreate_sec">
              ...
              <form id="create_ticket" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                <div class="row">
                  <div class="col-md-3"></div>
                  <div class="col-md-6">
                    <div class="row" style="box-shadow:1px 1px 11px grey;padding:4rem 4rem;">
                      <h2 class="text-center">Give Feedback
                        <hr>
                      </h2>
                      ...
                      <div class="col-md-12">
                        <div class="mb-3">
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control border-left-end" name="subject" id="subject"
                      ...
                      <div class="col-md-12 mt-2">
                        <div class="mb-3">
                          <div class="input-group">
                            ...
                            <textarea class="form-control" maxlength="400" rows="4" id="text" name="text"
                              spellcheck="false"
                              oninput="this.value = this.value.toLowerCase().replace(/[^a-z ]/g, '').replace(/\s+/g, ' ').replace(/\b\w/g, char => char.toUpperCase());">Enter Your text..</textarea>
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <button type="submit" class="btn btn-primary float-center mt-2 messagetxttt"
                            id="saveDetails"><i class="fa fa-save"></i> Submit</button>
                        </div>
                      </div>
  ...
  <script>
    ...
    $(document).ready(function () {
      $("#create_ticket").on("submit", function (e) {
        ...
        $.ajax({
          type: "POST",
          url: '<?= base_url() ?>website/ticketing/index/create_ticket',
