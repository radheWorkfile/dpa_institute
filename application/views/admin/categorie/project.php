...
<div class="content-body">
        ...
        <div class="card">
          <div class="card-header">
            ...
            <div class="card-action">
              <ul class="nav nav-tabs" role="tablist">
                <li class="nav-item py-1"> <span class="btn btn-outline-primary" id="projectSection"><b><i
                        class="la la-plus text-danger"></i></b>&nbsp;&nbsp;Create Project</span>
                </li>
              </ul>
            </div>
          </div>
          <div class="card-body">
            <div class="basic-form" id="createProSec">
              ...
              <form id="create" method="post" data-id="<?php echo $createProject ?>" accept-charset="utf-8"
                    ...
                    <div class="row mt-2">
                      ...
                      <div class="col-md-6" style="box-shadow:1px 1px 11px #80808029;padding:5rem 2rem 3rem 2rem;">
                        <div class="row">
                          <div class="col-md-12">
                            <div class="mb-3">
                              <label for="" class="text-color-g">&nbsp;&nbsp;Add Project <span
                                  class="text-danger">&nbsp;*</span></label>
                              <div class="input-group">
                                <span class="input-group-text"> <i class="fa fa-link text-color-g"></i> </span>
                                <input type="text" class="form-control border-left-end" name="project_name"
                                  id="project_name" placeholder="Enter Project Name .." required=""
                          ...
                          <div class="col-md-12">
                            <div class="mb-3">
                              <label for="" class="text-color-g">&nbsp;&nbsp;Enter Location<span
                                  class="text-danger">&nbsp;*</span></label>
                              <div class="input-group">
            ...
            <div class="invalid-feedback">Please Enter Heading.
                          ...
                          <div class="col-md-12 mt-2">
                            <div class="col-md-12">
                              ...
                              <div class="mb-3">
                                <div class="input-group">
                                  <span class="input-group-text"> <i class="fa fa-link text-color-g"></i> </span>
                                  <textarea class="form-control" maxlength="400" rows="3"
                                    placeholder="Enter Your Message" id="message" name="message" spellcheck="false"
                                    required=""
                          ...
                          <div class="row mt-4">
                            ...
                            <div class="col-md-4">
                              <button type="submit" class="btn btn-primary float-center mt-2" id="saveDetails"><i
            ...
            <div class="tab-content" id="projectList">
              <div class="tab-pane fade active show" id="allMembers" role="tabpanel">
                <div class="table-responsive">
                  <table id="projectItem" data-id="<?php echo $targetItem; ?>"
                    class="table table-hover table-responsive-sm mb-0">
                    <thead class="thead-arvDef">
                      <tr>
                        <th class="text-center"><strong>S.No</strong></th>
                        <th class="text-center"><strong>Project ID</strong></th>
  ...
  <script>
    ...
    $(document).ready(function () {
      let searchObj = {};
      var targetAction = $('#projectItem').attr('data-id');
      projectListItem = { printTable: function (search_data) { getpaginate(search_data, '#projectItem', targetAction, 'Only For Tnx id, Month.'); } };
    ...
    const pictureImageTxt = "Choose an Project image";
