...
<div class="content-body">
      ...
      <li class="nav-item py-1"> <span class="btn btn-outline-primary" id="banner_section"><b><i class="la la-plus text-danger"></i></b>&nbsp;&nbsp;Create Program</span>      
      </li>
      </ul>
      </div>
      </div>
      ...
      <form id="create" method="post" data-id="<?php echo $createProgram;?>" accept-charset="utf-8" enctype="multipart/form-data">
...
<div class="row">
            ...
            <input type="text" class="form-control border-left-end" name="project_name" id="project_name" placeholder="Enter Project Name .." required="" oninput="this.value = this.value.toLowerCase().replace(/[^a-z ]/g, '').replace(/\s+/g, ' ').replace(/\b\w/g, char => char.toUpperCase());">
            ...
            <input type="text" class="form-control border-left-end" name="location" id="location" placeholder="Enter Location ..." required="" oninput="this.value = this.value.toLowerCase().replace(/[^a-z ]/g, '').replace(/\s+/g, ' ').replace(/\b\w/g, char => char.toUpperCase());">
            <div class="invalid-feedback">Please Enter Heading.
            </div>
            </div>
            </div>
            ...
            <input type="date" class="form-control border-left-end" name="start_date" id="start_date" placeholder="Enter Start Date.." required="">
            <div class="invalid-feedback">Please Enter Heading.
            </div>
            </div>
            </div>
            ...
            <div class="input-group">
            <span class="input-group-text"> <i class="fa fa-user"></i> </span>
            <input type="date" class="form-control border-left-end" name="end_date" id="end_date" placeholder="Enter End Date.." required="">
            <div class="invalid-feedback">Please Enter Heading.
            </div>
            </div>
            </div>
            ...
            <div class="input-group">
            <span class="input-group-text"> <i class="fa fa-link text-color-g"></i> </span>  
            <textarea class="form-control" placeholder="Enter Your Message" maxlength="400" rows="3" id="message" name="message" spellcheck="false" required=""oninput="this.value = this.value.toLowerCase().replace(/[^a-z ]/g, '').replace(/\s+/g, ' ').replace(/\b\w/g, char => char.toUpperCase());"></textarea>
            ...
            <input type="file" name="programImg" id="picture__input">
            </div>
...
<!-- ============================================== Banner section end ================================== -->
        ...
        <table id="programList" data-id="<?php echo $programListItem; ?>" class="table table-hover table-responsive-sm mb-0">
        <thead class="thead-arvDef">
        <tr>
        <th class="text-center"><strong>S.No</strong></th>
        <th class="text-center"><strong>Program Id</strong></th>
        <th class="text-center"><strong>Program Name</strong></th>
...
.picture:hover {
  ...
  background: rgba(173, 240, 236, 0.6);;
    ...
    .picture__img {
     ...
     $(document).ready(function() {
     let searchObj = {};
     var targetAction = $('#programList').attr('data-id');
     programListItem = {
     printTable: function(search_data) {
     getpaginate(search_data, '#programList', targetAction, 'Only For Tnx id, Month.');
     }
     };
     programListItem.printTable(searchObj);           
     });
