        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="basic-form">
              ...
              <form id="create" method="post" data-id="<?php echo $targetValue ?>" accept-charset="utf-8"
                    ...
                    <div class="row mt-2">
                      ...
                      <div class="col-md-6" style="box-shadow:1px 1px 11px #80808029;padding:5rem 2rem 3rem 2rem;">
                        <div class="row">
                          <div class="col-md-12">
                            <div class="mb-3">
                              <label for="" class="text-color-g">&nbsp;&nbsp;Expense Name <span
                                  class="text-danger">&nbsp;*</span></label>
                              <div class="input-group">
                                <span class="input-group-text"> <i class="fa fa-link text-color-g"></i> </span>
                                <input type="text" class="form-control border-left-end" name="expenseName"
                                  id="expenseName" placeholder="Enter Income Source Name .."
                                  oninput="this.value = this.value.toLowerCase().replace(/[^a-z ]/g, '').replace(/\s+/g, ' ').replace(/\b\w/g, char => char.toUpperCase());"
                                  value="<?php echo $expense_data->expense_name ? $expense_data->expense_name : ''; ?>">
                              ...
                              <div class="mb-3">
                                <div class="input-group">
                                  ...
                                  <textarea class="form-control" maxlength="400" rows="3"
                                    ...
                                    oninput="this.value = this.value.toLowerCase().replace(/[^a-z ]/g, '').replace(/\s+/g, ' ').replace(/\b\w/g, char => char.toUpperCase());"><?php echo $expense_data->description ? $expense_data->description : ''; ?></textarea>
