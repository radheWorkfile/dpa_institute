                    ...
                    <div class="tab-content" id="banner_list" style="padding:1rem 2rem;">
                        <div class="tab-pane fade active show" id="allMembers" role="tabpanel">
                            <div class="table-responsive">
                                <table id="manageEmp" data-id="<?php echo $targetEmpItem; ?>" class="table table-hover table-responsive-sm mb-0">
...
<script>
    ...
    $(document).ready(function() {
        let searchObj = {};
        var targetAction = $('#manageEmp').attr('data-id');
        manageEmpList = {
            printTable: function(search_data) {
                getpaginate(search_data, '#manageEmp', targetAction, 'Only For Tnx id, Month.');
            }
        };
        manageEmpList.printTable(searchObj);
    });
</script>