...
<div class="content-body">
      ...
      <li class="nav-item py-1"> <span class="btn btn-outline-primary" id="banner_section"><b><i class="la la-plus text-danger"></i></b>&nbsp;&nbsp;Create Expense</span>      
      </li>
      </ul>
      </div>
      </div>
...
<form id="create" data-id="<?php echo $targetItem;?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
              <div class="row">
                ...
                <div class="col-md-10 mb-5">
                  <div class="row mt-4">
                    <div class="col-md-6">
                      <p class="text-man text-dark text-white">&nbsp;Select One</p>
                      <div class="mb-3 mt_1">
                    ...
                    <div class="col-md-6" id="projectSection" style="display:none;">
                      <p class="text-man text-dark text-white">&nbsp;Project Name</p>
                      <div class="mb-3 mt_1">
                    ...
                    <div class="col-md-6" id="programSection" style="display:none;">
                      <p class="text-man text-c-g text-white">&nbsp; Select Program</p>
                      <div class="mb-3 mt_1">
                    ...
                    <div class="col-md-6" id="eventSection" style="display:none;">
                      <div class="mb-3">
                        <p class="text-man text-dark text-white">Event Name</p>
                    ...
                    <div class="col-md-6">
                      <div class="mb-3">
                        <p class="text-man text-dark text-white">Expense Date</p>
                        <div class="input-group mt_1"> <span class="input-group-text icon-color"> <i class="fa fa-calendar text-color-g"></i> </span>
                        <input type="text" class="form-control border-left-end" name="s_date" id="s_date" placeholder="Select Start Date">
                          <div class="invalid-feedback">Please Enter Heading. </div>
                        </div>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <p class="text-man text-dark text-white">&nbsp;Payment Method</p>
                      <div class="mb-3 mt_1">
                    ...
                    <div class="col-md-6" id="recSection" style="display:none;">
                      <div class="mb-3">
                        <p class="text-man text-dark text-white">Enter Receiver  Name</p>
                    ...
                    <div class="col-md-6" id="recMobNumSec" style="display:none;">
                      <div class="mb-3">
                        <p class="text-man text-dark text-white">Receiver Mobile No</p>
                    ...
                    <div class="col-md-6">
                      <p class="text-man text-dark text-white">Amount</p>
                      <div class="mb-3 mt_1">
                        <div class="input-group"> <span class="input-group-text icon-color"> <i class="fa fa-inr text-color-g"></i> </span>
                  ...
                  <div class="row">
                    <div class="col-md-6 mt-2">
                      <p class="text-man text-dark text-white">&nbsp;Enter Message</p>
                      <div class="mb-3 mt_1">
                        <div class="input-group"> <span class="input-group-text icon-color"> <i class="fa fa-link text-color-g"></i> </span>
                    ...
                    <div class="col-md-6">
                      <p class="text-man text-dark text-white">&nbsp;Upload Payment screenshot.</p>
...
<!-- ============================================== Expense section end ================================== -->
        ...
        <table id="expenseList" data-id="<?php echo $expenseListItem; ?>" class="table table-hover table-responsive-sm mb-0">
        <thead class="thead-arvDef">
        <tr>
        <th class="text-center"><strong>S.No</strong></th>
        <th class="text-center"><strong>Expense Id</strong></th>
