                  ...
                  <div class="col-md-10 mb-5">
                    <div class="row mt-4">
                          ...
                          <div class="input-group"> <span class="input-group-text"> <i class="fa fa-link text-color-g"></i> </span>
                            <select class="form-control form-control-lg" id="otherIncome" name="otherIncome">
                              ...
                              <?php foreach ($income_category as $income): ?>
                                <option value="<?php echo $income['id']; ?>" <?php echo ($income['id'] == $income_data->otherIncome) ? 'selected' : ''; ?>>
                                  <?php echo $income['income_sources']; ?>
                                </option>
                              <?php endforeach; ?>
                            </select>
                      ...
                      <div class="col-md-6">
                        <div class="mb-3">
                          ...
                          <div class="input-group mt_1"> <span class="input-group-text icon-color"> <i class="fa fa-calendar text-color-g"></i> </span>
                            <input type="text" class="form-control border-left-end" name="incomeDate" id="incomeDate" value="<?php echo $income_data->created_at ? $income_data->created_at : ''; ?>" placeholder="Select Start Date">
                            <input type="hidden" name="id" id="id" value="<?php echo $income_data->id ? $income_data->id : ''; ?>">
                            <div class="invalid-feedback">Please Enter Heading. </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="mb-3 mt_1">
                          <div class="input-group"> <span class="input-group-text icon-color"> <i class="fa fa-inr text-color-g"></i> </span>
                            <input type="text" class="form-control border-left-end" name="proAmount" id="proAmount" placeholder="Enter  Amount" value="<?php echo $income_data->amount ? $income_data->amount : ''; ?>">
                            <div class="invalid-feedback">Please Enter Heading. </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6 mt-2">
                        ...
                        <div class="mb-3 mt_1">
                          <div class="input-group"> <span class="input-group-text icon-color"> <i class="fa fa-link text-color-g"></i> </span>
                            <textarea class="form-control" maxlength="400" rows="9" id="message" name="message" spellcheck="false" placeholder="Enter Message" oninput="this.value = this.value.toLowerCase().replace(/[^a-z ]/g, '').replace(/\s+/g, ' ').replace(/\b\w/g, char => char.toUpperCase());"><?php echo $income_data->message ? $income_data->message : ''; ?></textarea>
                      ...
                      <div class="col-md-6">
                        ...
                        <div id="uploadArea" class="upload-area" style="border-radius:0px!important;">
                          ...
                          <div class="upload-area__header">
                            <h5 class="text-black">Upload your file</h5>
                            <p class="upload-area__paragraph text-danger" style="margin-top:-0.5rem;color:black">File should be an image <strong class="upload-area__tooltip">Like <span class="upload-area__tooltip-data"></span>
                          ...
                          <div id="dropZoon" class="upload-area__drop-zoon drop-zoon" style="height:4.25rem!important;margin-top:-0.5rem;"> <span class="drop-zoon__icon"> <i class='bx bxs-file-image'></i> </span>
                            <p class="drop-zoon__paragraph text-success"> <img src="<?php echo base_url($income_data->income_proof ? $income_data->income_proof : 'Drop your file here or Click to browse'); ?>" alt="" style="height:4rem;"></p>
                            ...
                            <input type="file" id="fileInput" name="previewImage" class="drop-zoon__file-input" accept="image/*" value="<?php echo $income_data->income_proof ? $income_data->income_proof : ''; ?>">
                          </div>
                          <!-- End Drop Zoon -->
