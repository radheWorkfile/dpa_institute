                                                      ...
                                                      <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                  ...
                                                                  <div class="input-group m-t-1">
                                                                        <div class="input-group">
                                                                              ...
                                                                              <input type="text" class="form-control" placeholder="First Name" name="frstName" id="frstName" oninput="this.value=this.value.replace(/[^a-zA-Z\s]/g,'').replace(/\s+/g,' ')" value="<?php if ($isMember) {
                                                            ...
                                                            <div class="col-md-6">
                                                                  ...
                                                                  <div class="input-group m-t-1">
                                                                        <div class="input-group">
                                                                              <span class="input-group-text"> <i class="fa fa-user text-black"></i> </span>
                                                                              <input type="text" class="form-control" placeholder="Father Name" name="fatherName" id="fatherName" oninput="this.value=this.value.replace(/[^a-zA-Z\s]/g,'').replace(/\s+/g,' ')" value="<?php if ($isMember) {
                                                                                                                                                                                                                                                                              echo ($isMember->father_name ? $isMember->father_name : "");
                                                                                                                                                                                                                                                                        } ?>">
                                                                              <div class="invalid-feedback">Please Enter Heading.
                                                                              </div>
                                                                        </div>
                                                            ...
                                                            <div class="col-md-6 mt-3">
                                                                  ...
                                                                  <div class="input-group m-t-1">
                                                                        <div class="input-group">
                                                                              ...
                                                                              <input type="text" class="form-control" placeholder="Date of birth" id="dob" name="dob" value="<?php if ($isMember) {
                                                                                                                                                                                    echo ($isMember->dob ? $isMember->dob : "");
                                                                                                                                                                              } ?>">
                                                                              <div class="invalid-feedback">Please Enter Heading.
                                                                              </div>
                                                                        </div>
                                                            ...
                                                            <div class="col-md-6 mt-3">
                                                                  ...
                                                                  <div class="input-group m-t-1">
                                                                        <div class="input-group">
                                                                              <span class="input-group-text"> <i class="fa-solid fa-pen text-black"></i> </span>
                                                                              <input type="type" class="form-control keyUpAction" id="district_id" name="district_id" placeholder="Enter District" value="<?php if ($isMember) {
                                                                                                                                                                                                                  echo ($isMember->district_id ? $isMember->district_id : "");
                                                                                                                                                                                                            } ?>">
                                                                              <div class="invalid-feedback">Please Enter Heading.
                                                                              </div>
                                                                        </div>
                                                            ...
                                                            <div class="col-md-6 mt-3">
                                                                  ...
                                                                  <div class="input-group m-t-1">
                                                                        <div class="input-group">
                                                                              <span class="input-group-text"> <i class="fa-solid fa-pen text-black"></i> </span>
                                                                              <input type="type" class="form-control keyUpAction" id="state_id" name="state_id" placeholder="Enter State" value="<?php if ($isMember) {
                                                                                                                                                                                                            echo ($isMember->state_id ? $isMember->state_id : "");
                                                                                                                                                                                                      } ?>">
                                                                              <div class="invalid-feedback">Please Enter Heading.
                                                                              </div>
                                                                        </div>
                                                            ...
                                                            <div class="col-md-6 mt-3">
                                                                  ...
                                                                  <div class="input-group m-t-1">
                                                                        <div class="input-group">
                                                                              ...
                                                                              <input type="date" id="joingData" name="joingData" class="form-control" placeholder="Joining Date" value="<?php if ($isMember) {
                                                                                                                                                                                                echo ($isMember->joining_date ? $isMember->joining_date : "");
                                                                                                                                                                                          } ?>">
                                                                              <div class="invalid-feedback">Please Enter Heading.
                                                                              </div>
                                                                        </div>
                                                            ...
                                                            <div class="col-md-12 mt-4">
                                                                  ...
                                                                  <div class="mb-3 m-t-1">
                                                                        <div class="input-group"> <span class="input-group-text text-color-g"> <i class="fa fa-address-card"></i> </span>
                                                                              <textarea class="form-control" placeholder="Enter Full Address" rows="4" id="membrAddr" name="membrAddr"><?php if ($isMember) {
