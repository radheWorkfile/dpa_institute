        ...
        <div class="card-header border-0 pb-0 d-sm-flex d-block">
          ...
          <?php if($getMethod!='guest'){?>
            ...
            <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item">
                    <a class="nav-link miOjArvAction" data-bs-toggle="tab" data-bs-target="#deactiveMembers" href="javascript:void(0)" role="tab" aria-selected="false" data-id="<?php echo $getCurentList;?>" id="deactive_member">
                    <i class="fa fa-ban"></i> Deactive
                    </a>
                    </li>

                    <li class="nav-item">
                    <a class="nav-link miOjArvAction" data-bs-toggle="tab" data-bs-target="#activeMembers" href="javascript:void(0)" role="tab" aria-selected="false" data-id="<?php echo $getCurentList;?>" id="active_member">
                    <i class="fa-regular fa-circle-check"></i> Active
                    </a>
                    </li>

                    <li class="nav-item"> 
                    <a class="nav-link miOjArvAction active" data-bs-toggle="tab" data-bs-target="#allMembers" href="javascript:void(0)" role="tab" aria-selected="true" data-id="<?php echo $getCurentList;?>" id="all_member">
        	...
        	<div class="tab-content">
            	<div class="tab-pane fade active show" id="allMembers" role="tabpanel">
				   <div class="table-responsive">
                        <table id="tblDeactiveReport" data-id="<?php echo $targetAction;?>" class="table table-hover table-responsive-sm mb-0">
              ...
              <?php if($getMethod!='guest'){?> 
                <div class="tab-pane fade" id="deactiveMembers" role="tabpanel">
                      <div class="table-responsive">    
                        <table id="tblReportDetails" data-id="<?php echo $tblDeactive;?>" class="table table-hover table-responsive-sm mb-0">
                            <thead class="thead-arvDef">
                                <tr>
                                    <th class="text-center"><strong>S.No</strong></th>
                                    <th class="text-center"><strong>Registration ID</strong></th>
...
#tblReportDetails,#tblActiveReport{ width:100% !important;}
