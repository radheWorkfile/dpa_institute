                                          ...
                                          <form id="create_employee" method="post" accept-charset="utf-8" data-id="<?php echo $createAction; ?>" enctype="multipart/form-data">
                                                ...
                                                <div class="row">
                                                            ...
                                                            <div class="input-group m-t-1">
                                                                  <div class="input-group">
                                                                        <span class="input-group-text">
                                                                              <i class="fa-solid fa-phone text-color-g"></i></span>
                                                                        <input type="text" class="form-control" name="mobileNu" id="mobileNu" placeholder="Mobile Number" oninput="this.value=this.value.replace(/[^0-9]/g,'').replace(/(\ *?)\ */g,'$1')" value="<?php if ($isMember) {
                                                                                                                                                                                                                                                                        echo ($isMember->contact_no ? $isMember->contact_no : "");
                                                                                                                                                                                                                                                                  } ?>" maxlength="10">
                                                                        <div class="invalid-feedback">Please Enter Heading.
                                                                        </div>
                                                                  </div>
                                                      ...
                                                      <div class="col-md-6 mt-3">
                                                            ...
                                                            <div class="input-group m-t-1">
                                                                  <div class="input-group">
                                                                        <span class="input-group-text"> <i class="fa-solid fa-envelope text-color-g"></i> </span>
                                                                        <input type="email" class="form-control keyUpAction" id="email_id" name="email_id" placeholder="Email Address" value="<?php if ($isMember) {
                                                                                                                                                                                                      echo ($isMember->email ? $isMember->email : "");
                                                                                                                                                                                                } ?>">
                                                                        <div class="invalid-feedback">Please Enter Heading.
                                                                        </div>
                                                                  </div>
                                                      ...
                                                      <div class="col-md-6 mt-3">
                                                            ...
                                                            <div class="input-group m-t-1">
                                                                  <div class="input-group">
                                                                        <span class="input-group-text"> <i class="fa-solid fa-list text-color-g"></i> </span>
                                                      ...
                                                      <div class="col-md-12 mt-4">
                                                            ...
                                                            <div class="mb-3 m-t-1">
                                                                  <div class="input-group"> <span class="input-group-text text-color-g"> <i class="fa-solid fa-location-dot"></i> </span>
                                                      ...
                                                      <div class="row">
                                                            ...
                                                            <div class="col-md-6 mt-3">
                                                                  ...
                                                                  <div class="input-group m-t-1">
                                                                        <div class="input-group">
                                                                              <span class="input-group-text"> <i class="fa-solid fa-key text-color-g"></i> </span>
                                                            ...
                                                            <div class="row mt-5">
                                                                  ...
                                                                  <div class="col-md-2">
                                                                        <button type="submit" class="btn btn-primary" id="saveDetails"><i class="fa fa-save"></i> Update</button>
                                                                  </div>
                                                                  <div class="col-md-5"></div>
                                                            </div>
                                                      </div>
