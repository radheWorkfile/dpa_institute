      ...
      <div class="collapse navbar-collapse justify-content-between">
        ...
        <ul class="navbar-nav header-right">
            ...
            <div class="dropdown-menu dropdown-menu-end">
              <div id="DZ_W_Notification1" class="widget-media dz-scroll p-3" style="height:380px;">
                <ul class="timeline">
                  ...
                  <li>
                    <div class="timeline-panel">
                      <div class="media me-2 media-success"> <i class="fa fa-home"></i> </div>
                      <div class="media-body">
          ...
          <li class="nav-item dropdown header-profile"> <a class="nav-link" href="#" role="button" data-bs-toggle="dropdown"> <img src="<?php echo base_url('front/assets/sonu1.png');?>" width="20" alt="">
            <div class="header-info"> <span class="text-dark">Hey, <strong><?php echo $name;?></strong></span> <small><b class="text-success"><?php echo $asPosition;?></b></small> </div>
            </a>
            <div class="dropdown-menu dropdown-menu-right"> <a href="<?php echo base_url('employee/profile/manage');?>" class="dropdown-item ai-icon">
