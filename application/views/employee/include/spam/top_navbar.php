<!--**********************************Nav header start***********************************-->
    <div class="nav-header">
        <a href="index-2.html" class="brand-logo">
            <img class="logo-abbr" src="<?php echo base_url('front/logo/fabicon.png');?>" alt="">
						...
						<ul class="metismenu tab-nav-menu">
							...
							<li>
								...
								<ul aria-expanded="false">
									...
									<li><a href="index-3.html">Dark</a></li>
									<li><a href="index-4.html">Mini Sidebar</a></li>
									<li><a href="index-5.html">Sidebar</a></li>
								</ul>
							</li>
						</ul>
					</div>
					...
					<div class="tab-pane fade" id="apps">
						<ul class="metismenu tab-nav-menu">
							<li>
								...
								<ul aria-expanded="false">
									<li><a href="<?php echo base_url('administrator/employee/create');?>">Create New</a></li>
									<li><a href="app-calender.html">State Wise</a></li>
                                    <li><a href="app-calender.html">Distric Wise</a></li>
                                    <li><a href="app-calender.html">Block Wise</a></li>
                                    <li><a href="app-calender.html">Panchayat Wise</a></li>
                                    <li><a href="app-calender.html">Village/Town Wise</a></li>
								</ul>
							</li>
						</ul>
					</div>
