...
$(document).on("click", '.getAction', function() {
          ...
          $(function() {
              ...
              if (getData[0] == 'miStatusView') {
                ...
                $('.actnData').html(htmlAmi.msg);
                $('#statusChange').delay(2000).modal('hide');
...
.custom-height-3{height:3rem;}
::placeholder{font-size:0.8rem;}
.submitBtn{padding:0.5rem 2.8rem;background-color: #006f75;color: white;}
* {margin: 0;padding: 0;}
html {height: 100%;}
.custom-border-1{border:1px solid #ddd9d9!important;}
#msform {text-align: center;position: relative;margin-top: 20px;}
#msform fieldset .form-card {background: white;border: 0 none;border-radius: 0px;padding: 20px 40px 30px 40px;box-sizing: border-box;width: 94%;margin: 0 3% -3px 3%;position: relative;}
...
#msform input:focus, #msform textarea:focus {-moz-box-shadow: none !important;-webkit-box-shadow: none !important;box-shadow: none !important;border: none;font-weight: bold;border-bottom: 2px solid #006f75;outline-width: 0;}
#msform .action-button {width: 100px;background: #006f75;font-weight: bold;color: white;border: 0 none;border-radius: 0.2rem;cursor: pointer;padding: 8px 5px;margin: 10px 5px;}
#msform .action-button:hover, #msform .action-button:focus {box-shadow: 0 0 0 2px white, 0 0 0 3px #006f75;}
#msform .action-button-previous {width: 100px;background: #616161;font-weight: bold;color: white;border: 0 none;border-radius:0.4rem;cursor: pointer;padding: 10px 5px;margin: 10px 5px;}
...
select.list-dt:focus {border-bottom: 2px solid #006f75;}
...
#progressbar li.active:before, #progressbar li.active:after {background: #006f75;}
...
.fit-image{width: 100%;object-fit: cover;}
 ...
 /* kyc verification style section completed  */
         ...
         .mt-8{margin-top:8rem;}
		     .text-primary-light{color:#0053ff4d;}
		     .card-size{height:32rem;}
		     .text-404{font-size:8rem;}
