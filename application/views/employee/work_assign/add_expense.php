        ...
        <div class="card-header">
          ...
          <div class="card-action">
            <ul class="nav nav-tabs" role="tablist">
              <?php if($workingStatus->working_status == 3):?>
                <li class="nav-item py-1"><span class="btn bg-danger text-white">&nbsp;&nbsp;Closed&nbsp;&nbsp;</span></li>&nbsp;&nbsp;
              <?php else:?>
                <li class="nav-item py-1"> <span class="btn btn-outline-primary" id="banner_section"><i class="la la-plus text-primary"></i>&nbsp;&nbsp;Add Expense</span> </li>&nbsp;&nbsp;
                <li class="nav-item py-1"><a href="<?php echo base_url('employee/work_assign/closeWork/' . $runn_status->emp_id); ?>"><span class="btn btn-outline-primary"> Close</span></a></li>&nbsp;&nbsp;
              <?php endif;?>
            </ul>
          </div>
        </div>
            ...
            <form id="create" data-id="<?php echo $targetItem;?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
              <div class="row">
                ...
                <div class="col-md-10 mb-5">
                  <div class="row mt-4">   
                    <!-- project   program -->
                  <?php if($runn_status->project != ''):?>
                  <div class="col-md-6" id="projectSection">
                      <p class="text-man text-dark text-color-g">&nbsp;Enter Project Name</p>
                      <div class="mb-3">
                        <div class="input-group"> <span class="input-group-text icon-color"> <i class="fa fa-users"></i> </span>
                    ...
                    <?php endif;?>
                    <?php if($runn_status->program != ''):?>
                    <div class="col-md-6" id="programSection">
                    ...
                    <?php if($runn_status->event_name != ''):?>
                      <div class="col-md-6" id="eventSection">
                      <div class="mb-3">
                        <p class="text-man text-dark text-color-g">Assign worked</p>
                        <div class="input-group"> <span class="input-group-text icon-color"> <i class="fa fa-user"></i> </span>
                          <input type="type" class="form-control border-left-end" name="eventManage" id="eventManage" placeholder="Assign Worked">
                          <div class="invalid-feedback">Please Enter Heading. </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <?php if($runn_status->other_event_name != ''):?>
                      <div class="col-md-6" id="eventSection">
                      <div class="mb-3">
                        <p class="text-man text-dark text-color-g">Assign worked</p>
                        <div class="input-group"> <span class="input-group-text icon-color"> <i class="fa fa-user"></i> </span>
                          <input type="type" class="form-control border-left-end" name="other_event" id="other_event" placeholder="Assign Worked">
                          <div class="invalid-feedback">Please Enter Heading. </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="col-md-6">
                      <div class="mb-3">
                        ...
                        <div class="input-group"> <span class="input-group-text icon-color"> <i class="fa fa-calendar"></i> </span>
                          <input type="hidden" class="form-control border-left-end" name="workId" id="workId" value="<?php echo $runn_status->ass_work_id;?>">
                          <input type="hidden" class="form-control border-left-end" name="emp_id" id="emp_id" value="<?php echo $runn_status->emp_id;?>">
                    ...
                    <div class="col-md-6" id="recSection" style="display:none;">
                      <div class="mb-3">
                        ...
                        <div class="input-group"> <span class="input-group-text icon-color"> <i class="fa fa-envelope"></i> </span>
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="mb-3">
                        <div class="input-group"> <span class="input-group-text icon-color"> <i class="fa fa-users"></i> </span>
                          <input type="text" class="form-control border-left-end" name="location" id="location" placeholder="Enter Location.." oninput="this.value = this.value.toLowerCase().replace(/[^a-z ]/g, '').replace(/\s+/g, ' ').replace(/\b\w/g, char => char.toUpperCase());">
                          <div class="invalid-feedback">Please Enter Heading. </div>
                        </div>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <p class="text-man text-dark text-color-g">Invest  Amount</p>
                      <div class="mb-3">
                        <div class="input-group"> <span class="input-group-text icon-color"> <i class="fa fa-users"></i> </span>
                  ...
                  <div class="row">
                    <div class="col-md-6 mt-2">
                      ...
                      <div class="mb-3">
                        <div class="input-group"> <span class="input-group-text icon-color"> <i class="fa fa-address-card"></i> </span>
                          <textarea class="form-control" maxlength="400" rows="9" placeholder="Enter Message" id="message" name="message" spellcheck="false" oninput="this.value = this.value.toLowerCase().replace(/[^a-z ]/g, '').replace(/\s+/g, ' ').replace(/\b\w/g, char => char.toUpperCase());"></textarea>
              ...
              <div class="table-responsive">
                <table id="targetSection" data-id="<?php echo $targetList; ?>" class="table table-hover table-responsive-sm mb-0">
                  <thead class="thead-arvDef">
                    <tr>
                      <th clas="text-center"><strong>S.No</strong></th>
                      <th clas="text-center"><strong>Work Id</strong></th>
                      <th clas="text-center"><strong>Emp Id</strong></th>
                      <th clas="text-center"><strong>Emp Name</strong></th>
                      <th clas="text-center"><strong>Project Name</strong></th>
                      <th clas="text-center"><strong>Location</strong></th>
                      <th clas="text-center"><strong>Expense Amount</strong></th>
                      <th clas="text-center"><strong>Date</strong></th>
                      <th clas="text-center"><strong>Status</strong></th>
                    </tr>
                  </thead>
                </table>
              </div>
