            ...
            <form id="create" data-id="<?php echo $targetItem;?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
              <div class="row">
                  ...
                  <div class="row mt-4">
                    ...
                    <div class="col-md-6" id="otherSection" style="display:none;">
                      <div class="mb-3">
                        ...
                        <div class="input-group"> <span class="input-group-text icon-color"> <i class="fa fa-user"></i> </span>
                          <input type="text" class="form-control border-left-end" name="otherWork" id="otherWork" placeholder="Enter Wrok Name">
                          <div class="invalid-feedback">Please Enter Heading. </div>
                        </div>
                      </div>
                    </div>
                        ...
                        <div class="input-group"> <span class="input-group-text icon-color"> <i class="fa fa-users"></i> </span>
                          <select class="form-control form-control-lg" id="employee_id" name="employee_id">
                            ...
                            <?php foreach ($allEmpLIst as $empList): ?>
                              <option value="<?php echo $empList['id']; ?>" <?php echo $empList['id'] == $workDetails->emp_id ? 'selected' : ''; ?>><?php echo $empList['first_name'] . ' ' . $empList['last_name']; ?></option>
                            <?php endforeach; ?>
                          </select>
                          <div class="invalid-feedback">Please Enter Heading. </div>
                        </div>
                    ...
                    <div class="col-md-6">
                      <div class="mb-3">
                        ...
                        <div class="input-group"> <span class="input-group-text icon-color"> <i class="fa fa-envelope"></i> </span>
                          <input type="date" class="form-control border-left-end" name="s_date" id="s_date" value="<?php echo $workDetails->start_date;?>">
                          <input type="hidden" class="form-control border-left-end" name="id" id="id" value="<?php echo $workDetails->id;?>">
                          <div class="invalid-feedback">Please Enter Heading. </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="mb-3">
                        <div class="input-group"> <span class="input-group-text icon-color"> <i class="fa fa-users"></i> </span>
                          <input type="text" class="form-control border-left-end" name="location" id="location" value="<?php echo $workDetails->location?$workDetails->location:'';?>" placeholder="Enter Location.." oninput="this.value = this.value.toLowerCase().replace(/[^a-z ]/g, '').replace(/\s+/g, ' ').replace(/\b\w/g, char => char.toUpperCase());">
                          <div class="invalid-feedback">Please Enter Heading. </div>
                        </div>
                      </div>
                    </div>
                    <div class="col-md-6">
                      ...
                      <div class="mb-3">
                        <div class="input-group"> <span class="input-group-text icon-color"> <i class="fa fa-users"></i> </span>
                          <input type="text" class="form-control border-left-end" name="proAmount" id="proAmount" placeholder="Enter  Amount" value="<?php echo $workDetails->amount?'₹ ' .$workDetails->amount.'.00':'';?>">
                          <div class="invalid-feedback">Please Enter Heading. </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="col-md-6 mt-2">
                      ...
                      <div class="mb-3">
                        <div class="input-group"> <span class="input-group-text icon-color"> <i class="fa fa-address-card"></i> </span>
                          <textarea class="form-control" maxlength="400" rows="9" id="message" name="message" placeholder="Enter Message" spellcheck="false" oninput="this.value = this.value.toLowerCase().replace(/[^a-z ]/g, '').replace(/\s+/g, ' ').replace(/\b\w/g, char => char.toUpperCase());"><?php echo $workDetails->message?$workDetails->message:'';?></textarea>
                ...
                <div class="row mb-5">
                  ...
                  <div class="col-md-7">
                    <button type="submit" name="submit" class="btn btn-primary float-center mt-2" id="saveDetails"><i class="fa fa-save"></i> Update</button>
                  </div>
                </div>
              </div>
            </form>
