...
<div class="content-body">
      ...
      <li class="nav-item py-1"> <span class="btn btn-outline-primary" id="banner_section"><i class="la la-plus text-primary"></i>&nbsp;&nbsp;Add Feedback</span>      
      </li>
      </ul>
      </div>
      </div>
      ...
      <div class="basic-form" id="bannerCreate_sec">
          ...
          <form id="create" data-id="<?php echo $targetItem;?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
            ...
            <span class="input-group-text"> <i class="fa fa-link color-g"></i> </span>
            <input type="text" class="form-control border-left-end" name="subject" id="subject" placeholder="Enter Subject.." required="">
            ...
            <div class="input-group m-t-1">
            <span class="input-group-text"> <i class="fa fa-link color-g"></i> </span>
            <textarea class="form-control" maxlength="400" rows="4" id="discription" name="discription" spellcheck="false" required="" placeholder="Enter Message"></textarea>
            <div class="invalid-feedback">Please Enter Heading.
            </div>
            </div>
            </div>
            ...
            <div class="tab-content" id="banner_list">
              <div class="tab-pane fade active show" id="allMembers" role="tabpanel">
                <div class="table-responsive">
                  <table id="targetSection" data-id="<?php echo $targetFeedbackItem; ?>" class="table table-hover table-responsive-sm mb-0">
