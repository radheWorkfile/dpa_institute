                                ...
                                <table id="targetItem" data-id="<?php echo $targetItemLIst; ?>" class="table table-hover table-responsive-sm mb-0">
                                    <thead class="thead-arvDef">
                                        <tr>
                                            ...
                                            <th class="text-center" class="text-center"><strong>Donation Id</strong></th>
                                            <th class="text-center" class="text-center"><strong>Name</strong></th>
                                            <th class="text-center" class="text-center"><strong>Mobile No</strong></th>
                                            <th class="text-center" class="text-center"><strong>Image</strong></th>
