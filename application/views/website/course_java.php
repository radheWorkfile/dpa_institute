...
<head>
    ...
    <title>Java Language ||  DPA Computer Institute</title>
...
<body>
    ...
    <div class="container-fluid p-0 position-relative">
        <img src="<?php echo base_url(); ?>website_assets/Hero-section/java_banner.png" class="w-100  mobile-height-set" alt="">
        <div class="all-common-banner-text">
            <h3 class="fw-bolder text-shadow">Java Language</h3>
            <div class="d-flex link-part-hero gap-3"><a href="<?php echo base_url() ?>site">Home</a>/ <p class="mb-0">Java Language</p>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-7 my-3 ">
                    <h3 class="fw-bolder animated-text cm">Java Language</h3>
                    <div>
                        <p class="text-justify" data-aos="fade-in"
                            data-aos-duration="3000">
                          <b>Java</b> is a High Level, object-oriented programming language used for developing cross-platform applications. It's known for portability, security, and scalability, making it ideal for web, mobile, and software development.
                    </div>
                    <div class="">
                        ...
                        <div class="col-12 col-lg-6 my-3">
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Introduction to Java</span></p>
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Control Flow Statements</span></p>
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Object-Oriented Programming</span></p>
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> File Handling (I/O in Java) </span></p>
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Interfaces and Abstract Classes </span></p>
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Lambda Expressions </span></p>
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> File Handling </span></p>
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Best Practices and Design </span></p>
                        </div>
                        <div class="col-12 col-lg-6 my-3">
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Basics of Java</span></p>
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Arrays and Strings </span></p>
                            ...
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Packages and Access Modifiers</span></p>
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Multithreading</span></p>
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Functional Programming</span></p>
                ...
                <div class="col-12 col-lg-4 my-3">
                       ...
                       <div class="card p-2">
                          ...
                          <div class="p-1 border-bottom border-secondary bg-g">
                            <p class="mt-2 px-3 text-shadow"><span class="fw-bold">Course :</span><span class="float-end">Java Language</span></p>
                          </div>
                       ...
                       <div class="mt-4 border p-2">
                        <img src="<?php echo  base_url('website_assets/all/java.jpg');?>" alt="" class="w-100">
                       </div>
