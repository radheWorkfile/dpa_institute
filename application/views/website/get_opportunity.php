...
<head>
    ...
    <title>Get Opportunity || NGO </title>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 order-2 order-lg-0">
                    <p><img src="<?php echo base_url(); ?>website_assets/oops.png" class="w-100" alt="">
                    </p>
                </div>
                <div class="col-lg-8 d-flex align-items-center">
                   <div>
                   <div class="position-relative d-inline">
                        <span class="subtitle-part">Open the Door to Success</span>
                    </div>
