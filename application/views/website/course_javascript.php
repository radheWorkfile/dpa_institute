...
<head>
    ...
    <title>JavaScript ||  DPA Computer Institute</title>
    <?php include("includes/css.php"); ?>
    <style>
      .m_m{margin-left: 0.7rem;margin-top: -1.1rem;}
    </style>
</head>
...
<body>
    ...
    <div class="container-fluid p-0 position-relative">
        <img src="<?php echo base_url(); ?>website_assets/Hero-section/js_banner.png" class="w-100  mobile-height-set" alt="">
        <div class="all-common-banner-text">
            <h3 class="fw-bolder text-shadow">JavaScript</h3>
            <div class="d-flex link-part-hero gap-3"><a href="<?php echo base_url() ?>site">Home</a>/ <p class="mb-0">JavaScript</p>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-7 my-3 ">
                    <h3 class="fw-bolder animated-text cm">JavaScript</h3>
                    <div>
                        <p class="text-justify" data-aos="fade-in"
                            data-aos-duration="3000">
                           <b>JavaScript</b> is a versatile, high-level programming language used primarily for web development. It enables interactive web pages, supports event-driven programming, and runs in browsers as well as on servers.
                    </div>
                    <div class="">
                  ...
                  <div class="col-12 col-lg-6 my-3">
                      <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></span><span class="cm"> Introduction to JavaScript</span></p>
                      <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></span><span class="cm"> Setting Up the Environment</span></p>
                      <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></span><span class="cm"> Basic Syntax</span></p>
                      <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></span><span class="cm"> Variables and Data Types</span></p>
                      <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></span><span class="cm"> Operators</span></p>
                      <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></span><span class="cm"> Control Structures</span></p>
                      <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></span><span class="cm"> Functions</span></p>
                      <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></span><span class="cm"> Events and Event Handling</span></p>
                      <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></span><span class="cm"> Objects and Arrays</span></p>
                      <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></span><span class="cm"> DOM Manipulation</span></p>
                  </div>
                  <div class="col-12 col-lg-6 my-3">
                      <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></span><span class="cm"> Form Validation</span></p>
                      <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></span><span class="cm"> ES6+ Features</span></p>
                      <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></span><span class="cm"> Fetch API & AJAX</span></p>
                      <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></span><span class="cm"> Object-Oriented JavaScript</span></p>
                      <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></span><span class="cm"> Closures and Scope</span></p>
                      <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></span><span class="cm"> Local & Session Storage</span></p>
                      <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></span><span class="cm"> Error Handling</span></p>
                      <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></span><span class="cm"> JavaScript Modules</span></p>
                      <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></span><span class="cm"> Debugging with Developer Tools</span></p>
                  </div>
                      <p class="px-2 m_m"><span><i class="fa fa-fire cm" aria-hidden="true"></i></span><span class="cm"> Asynchronous JavaScript (Promises & async/await)</span></p>
                ...
                <div class="col-12 col-lg-4 my-3">
                       ...
                       <div class="card p-2">
                          ...
                          <div class="p-1 border-bottom border-secondary bg-g">
                            <p class="mt-2 px-3 text-shadow"><span class="fw-bold">Course :</span><span class="float-end">JavaScript</span></p>
                          </div>
                       ...
                       <div class="mt-4 border p-2">
                        <img src="<?php echo  base_url('website_assets/all/java_script.jpg');?>" alt="" class="w-100">
                       </div>
