...
<head>
    ...
    <title>HTML ||  DPA Computer Institute</title>
...
<body>
    ...
    <div class="container-fluid p-0 position-relative">
        <img src="<?php echo base_url(); ?>website_assets/Hero-section/html_banner.png" class="w-100  mobile-height-set" alt="">
        <div class="all-common-banner-text">
            <h3 class="fw-bolder text-shadow">HTML Language</h3>
            <div class="d-flex link-part-hero gap-3"><a href="<?php echo base_url() ?>site">Home</a>/ <p class="mb-0">HTML Language</p>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-7 my-3 ">
                    <h3 class="fw-bolder animated-text cm">HTML Language</h3>
                    <div>
                        <p class="text-justify" data-aos="fade-in"
                            data-aos-duration="3000">
                          <b>HTML</b> (HyperText Markup Language) is the standard language used to create and structure content on the web, using elements like headings, paragraphs, links, and images to build webpages.
                    </div>
                    <div class="">
                        ...
                        <div class="col-12 col-lg-6 my-3">
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Introduction to HTML</span></p>
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Basic HTML Structure</span></p>
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> HTML Elements and Attributes</span></p>
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Links and Anchors </span></p>
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Tables in HTML </span></p>
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Semantic Element </span></p>

                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> HTML5 New Features </span></p>
                        </div>
                        <div class="col-12 col-lg-6 my-3">
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Setting Up the Environment</span></p>
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Text Formatting Tags </span></p>
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Links and Anchors </span></p>
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Lists in HTML</span></p>
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Forms and Input Elements</span></p>
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Multimedia Elements</span></p>

                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Project/Practical Implementation</span></p>
                ...
                <div class="col-12 col-lg-4 my-3">
                       ...
                       <div class="card p-2">
                          ...
                          <div class="p-1 border-bottom border-secondary bg-g">
                            <p class="mt-2 px-3 text-shadow"><span class="fw-bold">Course :</span><span class="float-end">HTML</span></p>
                          </div>
                          ...
                          <div class="p-1  bg-g  border-bottom border-secondary">
                            <p class="mt-2 px-3 text-shadow"><span class="fw-bold">Duration :</span><span class="float-end">2 Month</span></p>
                          </div>
                          <div class="p-1 bg-g  border-bottom border-secondary">
                       ...
                       <div class="mt-4 border p-2">
                        <img src="<?php echo  base_url('website_assets/all/html.jpg');?>" alt="" class="w-100">
                       </div>
