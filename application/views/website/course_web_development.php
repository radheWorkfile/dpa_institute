...
<head>
    ...
    <title>Web Development ||  DPA Computer Institute</title>
...
<body>
    ...
    <div class="container-fluid p-0 position-relative">
        ...
        <div class="all-common-banner-text">
            <h3 class="fw-bolder text-shadow">Web Development</h3>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-7 my-3 ">
                    <h3 class="fw-bolder animated-text cm">Web Development</h3>
                    <div>
                        <p class="text-justify" data-aos="fade-in"
                            data-aos-duration="3000">
                            Web development involves creating and maintaining websites or web applications. It includes front-end design, back-end coding, and server management to ensure functionality, performance, and a seamless user experience online.
                    </div>
                    <div class="">
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-6 my-3">
                          ...
                          <div class="col-12 col-lg-6 my-3">
                            ...
                            <p class="px-2"><span><i class="fa fa-check-circle cm" aria-hidden="true"></i></span><span class="cm"> Basic SQL / MySQL </span></p>
                ...
                <div class="col-12 col-lg-4 my-3">
                       ...
                       <div class="card p-2">
                          ...
                          <div class="p-1 border-bottom border-secondary bg-g">
                            <p class="mt-2 px-3 text-shadow"><span class="fw-bold">Course :</span><span class="float-end">Web Development</span></p>
                          </div>
                          ...
                          <div class="p-1 bg-g  border-bottom border-secondary">
                            <p class="mt-2 px-3 text-shadow"><span class="fw-bold">Price :</span><span class="float-end">Rs - 15,000.00 </span></p>
                          </div>
                       </div>
