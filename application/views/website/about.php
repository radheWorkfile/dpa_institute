...
<body>
    ...
    <div class="container-fluid p-0 position-relative">
        <img src="<?php echo base_url(); ?>website_assets/Hero-section/about_hero.png" class="w-100  mobile-height-set" alt="">
        <div class="all-common-banner-text">
            <h3 class="fw-bolder">About Us</h3>
            <div class="d-flex link-part-hero gap-3"><a href="<?php echo base_url() ?>site">Home</a>/ <p class="mb-0">About Us</p>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-7 my-3 ">
                    <h3 class="fw-bolder animated-text">Who We Are</h3>
                    <div>
                ...
                <div class="col-12 col-lg-5 my-3">
                    <div>
                        <img src="<?php echo base_url(); ?>website_assets/all/who.png" class="w-100 drop-bg" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 order-2 order-lg-0">
                    <p><img src="<?php echo base_url(); ?>front/ngo_img/banner/about-us-img.png" class="w-100" alt="">
                    </p>
                </div>
                <div class="col-lg-8">
    ...
    <section class="container-fluid my-3 my-lg-4">
        <div class="container">
            <div class="row">
                <div class="col-lg-4 order-2 order-lg-0">
                    <p><img src="<?php echo base_url(); ?>website_assets/all/mv.png" class="w-100" alt="">
                    </p>
                </div>
                <div class="col-lg-8">
                    <div class="position-relative d-inline">
                        <span class="subtitle-part">Our Mission & Vision</span>
                    </div>
                    <h2 class="text-color fw-bolder my-2 animated-text">Driving Change: Our Mission and Vision
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-center">
                    <h2 class="animated-text">What People Say About Us</h2>
                    <p>Our work speaks through the voices of those we serve. These stories reflect the real-life impact of our programs and the deep connections we’ve built with individuals and communities across the regions we serve.
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid py-3 ">
        <div class="container">
            <div class="slider-container  p-3">
                <div class="owl-carousel owl-carousel-aboutTeam owl-theme">
                    <div class="item " data-aos="zoom-in"
                        data-aos-duration="3000">
                        <div class="testimonial-about-part">
                            <div class="d-flex justify-content-between">
                                <img src="<?php echo base_url('website_assets/all/testi-icon.png'); ?>"
                                    class="rotate-180" alt="Image 1">
                                <img src="<?php echo base_url('website_assets/all/testi-icon.png'); ?>"
                                    alt="Image 1">
                            </div>
                            <div>
                                <div class="text-center d-flex justify-content-center test-image">
