...
<head>
    ...
    <title>SQL / My SQL ||  DPA Computer Institute</title>
...
<body>
    ...
    <div class="container-fluid p-0 position-relative">
        <img src="<?php echo base_url(); ?>website_assets/Hero-section/sql_banner.png" class="w-100  mobile-height-set" alt="">
        <div class="all-common-banner-text">
            <h3 class="fw-bolder text-shadow">SQL / My SQL </h3>
            <div class="d-flex link-part-hero gap-3"><a href="<?php echo base_url() ?>site">Home</a>/ <p class="mb-0">SQL / My SQL </p>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-7 my-3 ">
                    <h3 class="fw-bolder animated-text cm">SQL / My SQL </h3>
                    <div>
                        <p class="text-justify" data-aos="fade-in"
                            data-aos-duration="3000">
                          <b>SQL (Structured Query Language)</b> is used to manage and manipulate relational databases. MySQL is a popular open-source SQL-based database system widely used for web development and data storage.
                    </div>
                    <div class="">
                ...
                <div class="col-12 col-lg-4 my-3">
                       ...
                       <div class="card p-2">
                          ...
                          <div class="p-1 border-bottom border-secondary bg-g">
                            <p class="mt-2 px-3 text-shadow"><span class="fw-bold">Course :</span><span class="float-end">SQL / My SQL </span></p>
                          </div>
                       ...
                       <div class="mt-4 border p-2">
                        <img src="<?php echo  base_url('website_assets/all/sql.jpg');?>" alt="" class="w-100">
                       </div>
