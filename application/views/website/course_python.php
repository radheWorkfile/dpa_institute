...
<head>
    ...
    <title>Python ||  DPA Computer Institute</title>
...
<body>
    ...
    <div class="container-fluid p-0 position-relative">
        <img src="<?php echo base_url(); ?>website_assets/Hero-section/python_banner.png" class="w-100  mobile-height-set" alt="">
        <div class="all-common-banner-text">
            <h3 class="fw-bolder text-shadow">Python Language</h3>
            <div class="d-flex link-part-hero gap-3"><a href="<?php echo base_url() ?>site">Home</a>/ <p class="mb-0">Python Language</p>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-7 my-3 ">
                    <h3 class="fw-bolder animated-text cm">Python Language</h3>
                    <div>
                        <p class="text-justify" data-aos="fade-in"
                            data-aos-duration="3000">
                           <b>Python</b> is a high-level, versatile programming language known for its simplicity and readability. It's widely used in web development, data science, automation, artificial intelligence, and software development.
                    </div>
                    <div class="">
                        ...
                        <div class="col-12 col-lg-6 my-3">
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Introduction to Python</span></p>
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Control Flow Statements</span></p>
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Functions in Python</span></p>
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Object-Oriented Programming </span></p>
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Modules and Packages </span></p>
                        ...
                        <div class="col-12 col-lg-6 my-3">
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Python Basics</span></p>
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Operators and Expressions </span></p>
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Data Structures in Python </span></p>
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Exception Handling</span></p>
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> File Handling</span></p>
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Working with Databases</span></p>
                ...
                <div class="col-12 col-lg-4 my-3">
                       ...
                       <div class="card p-2">
                          ...
                          <div class="p-1 border-bottom border-secondary bg-g">
                            <p class="mt-2 px-3 text-shadow"><span class="fw-bold">Course :</span><span class="float-end">Python</span></p>
                          </div>
                       ...
                       <div class="mt-4 border p-2">
                        <img src="<?php echo  base_url('website_assets/all/Python.jpg');?>" alt="" class="w-100">
                       </div>
