...
<body>
    ...
    <div class="container-fluid p-0 position-relative">
        <img src="<?php echo base_url(); ?>website_assets/Hero-section/c_plus_banner.png" class="w-100  mobile-height-set" alt="">
                ...
                <div class="col-12 col-lg-7 my-3 ">
                    ...
                    <div>
                        <p class="text-justify" data-aos="fade-in"
                          ...
                          <b>C++</b> is a powerful, high-performance programming language used for system/software development. It supports object-oriented, procedural, and generic programming, making it ideal for complex applications like games, engines, and operating systems.
                    </div>
                    <div class="">
                        ...
                        <div class="col-12 col-lg-6 my-3">
                            ...
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Control Structures</span></p>
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Object-Oriented Programming</span></p>
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Polymorphism </span></p>
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Operator Overloading </span></p>
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> File Handling </span></p>
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Pointers and References </span></p>
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Structures and Unions </span></p>
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Projects / Mini Applications </span></p>
                        </div>
                        <div class="col-12 col-lg-6 my-3">
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Basics of C++</span></p>
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Functions </span></p>
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Inheritance </span></p>
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Functions</span></p>
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Encapsulation and Abstraction</span></p>

                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Exception Handling</span></p>
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Dynamic Memory Management</span></p>
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Namespace</span></p>
                ...
                <div class="col-12 col-lg-4 my-3">
                       ...
                       <div class="card p-2">
                          ...
                          <div class="p-1 border-bottom border-secondary bg-g">
                            <p class="mt-2 px-3 text-shadow"><span class="fw-bold">Course :</span><span class="float-end">C++</span></p>
                          </div>
                       ...
                       <div class="mt-4 border p-2">
                        <img src="<?php echo  base_url('website_assets/all/course_c_plus.jpg');?>" alt="" class="w-100">
                       </div>
