...
<head>
    ...
    <title>C Language ||  DPA Computer Institute</title>
...
<body>
    ...
    <div class="container-fluid p-0 position-relative">
        <img src="<?php echo base_url(); ?>website_assets/Hero-section/c_lang.png" class="w-100  mobile-height-set" alt="">
        <div class="all-common-banner-text">
            <h3 class="fw-bolder text-shadow">C Language</h3>
            <div class="d-flex link-part-hero gap-3"><a href="<?php echo base_url() ?>site">Home</a>/ <p class="mb-0">C Language</p>
            </div>
        </div>
    </div>
    ...
    <!-- Who We Are start -->
    <div class="container-fluid py-2 my-2 my-lg-4 py-lg-5">
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-7 my-3 ">
                    <h3 class="fw-bolder animated-text cm">C Language</h3>
                    <div>
                        <p class="text-justify" data-aos="fade-in"
                            data-aos-duration="3000">
                          <b> C </b> is a powerful, low-level programming language used for system programming, operating systems, and embedded systems. It provides direct memory access, fast performance, and is foundational for learning programming.
                    </div>
                    <div class="">
                        <p><span class="bg_orange py-1 px-3 text-white rounded-pill">Duration - 4 Month</span></p></p>
                        <p><span class="bgm py-1 text-white rounded-pill"style="padding:0rem 1.7rem;">Course Content</span></p>
                    </div>
                  
                                        <div class="row">
                        <div class="col-12 col-lg-6 my-3">
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Introduction to C</span></p>
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Data Types and Variables</span></p>
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Input and Output (I/O)</span></p>
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Loops (for, while, do-while) </span></p>
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Arrays </span></p>
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Pointers </span></p>

                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> File Handling </span></p>
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Preprocessor Directives </span></p>
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Storage Classes </span></p>
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Bitwise Operators </span></p>
                        </div>
                        <div class="col-12 col-lg-6 my-3">
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Structure of a C Program</span></p>
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Operators and Expressions </span></p>
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Control Statements (if, else, switch) </span></p>
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Functions</span></p>
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Strings</span></p>
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Structures and Unions</span></p>

                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Dynamic Memory Allocation</span></p>
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Recursion</span></p>
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Enumerations (enum)</span></p>
                            <p class="px-2"><span><i class="fa fa-fire cm" aria-hidden="true"></i></i></span><span class="cm"> Command Line Arguments</span></p>
                ...
                <div class="col-12 col-lg-4 my-3">
                       ...
                       <div class="card p-2">
                          <div class="bgm">
                            <h4 class="text-center fw-bold text-white text-shadow mt-3">Course Information</p>
                          </div>
                          <div class="p-1 border-bottom border-secondary bg-g">
                            <p class="mt-2 px-3 text-shadow"><span class="fw-bold">Course :</span><span class="float-end">Digital Marketing</span></p>
                          </div>
                          <div class="p-1  bg-g  border-bottom border-secondary">
                            <p class="mt-2 px-3 text-shadow"><span class="fw-bold">Levels :</span><span class="float-end">Beginner</span></p>
                          </div>
                          <div class="p-1  bg-g  border-bottom border-secondary">
                            <p class="mt-2 px-3 text-shadow"><span class="fw-bold">Duration :</span><span class="float-end">4 Month</span></p>
                          </div>
                          <div class="p-1 bg-g  border-bottom border-secondary">
                            <p class="mt-2 px-3 text-shadow"><span class="fw-bold">Class Size :</span><span class="float-end">20 Persion</span></p>
                          </div>
                          <div class="p-1 bg-g  border-bottom border-secondary">
                            <p class="mt-2 px-3 text-shadow"><span class="fw-bold">Price :</span><span class="float-end">Rs - 10,000.00 </span></p>
                          </div>
                       </div>


                       <div class="mt-4 border p-2">
                        <img src="<?php echo  base_url('website_assets/lug_img/google-add.jpg');?>" alt="" class="w-100">
                       </div>
