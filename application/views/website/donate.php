                    ...
                    <div class=" p-2 p-md-3 p-lg-4 ">
                        <form id="donateNow" method="POST" enctype="multipart/form-data" class="">
                            <div>
                                ...
                                <p class="" data-aos="fade-in"
                                    data-aos-duration="3000">“ Support us today by donating through our Donation page. We’re here to assist with any questions and guide you through the process. ”</p>
                                ...
                                <div>
                                    <textarea placeholder="Type your Message Here...."
                                        ...
                                        oninput="this.value = this.value.toLowerCase().replace(/[^a-z0-9,. ]/g, '').replace(/\s+/g, ' ').replace(/\b\w/g, char => char.toUpperCase());"></textarea>
                                ...
                                <div class="row" id="donate-payment">
                                        ...
                                        <div class="col-md-6">
                                            <div class="row" style="border:1px dashed #aaa3a3;padding:0.8rem 0.5rem 1rem 0.5rem;">
                                                ...
                                                <div class="col-md-12" style="display:flex;justify-content:space-between">
                                                    <p class="text-dark">Account No &nbsp;-
                                                    <p>
                                                    <p class="text-dark"> 69234156784325345</p>
                                                </div>
                                                <div class="col-md-12" style="display:flex;justify-content:space-between">
                                                    <p class="text-dark">IFSC-CODE &nbsp;-
                                                    <p>
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-1"></div>
                                        <div id="payment_img_error" class="error text-danger pt-1" style="text-align:center;"></div>
                                ...
                                <div>
                                    <button class="donAmo btn-organe-common  w-100 messagetxttt" type="submit" id="donate_submit">Submit</button>
                                </div>
        ...
        $(document).ready(function() {
            $("#donateNow").submit(function(e) {
                ...
                $.ajax({
                    ...
                    $('#email_error').html(response.msg.email).addClass('tDanger').fadeIn().delay(2000).fadeOut();}
                    }
                });
            });
        });
