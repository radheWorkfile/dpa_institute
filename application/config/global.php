...
defined('BASEPATH') OR exit('Can we play bubu together ?');
	...
	$config['license_key'] = "677b0e74a4147b2fe56a75b66b9e2236";
	//9D2O-T13X-5A0W-39WQ-0JN8
	$config['is_valid'] = "validate";
	$config['is_expiry'] ="MTcyNzMwMTU5OQ==";
	//md5(base64_encode('25-09-2024 23:59:59'))//     MTY5NTY2NjU5OQ==
